...
/** Gets the banner by index within a leg */
- (nullable MBXBannerInstruction *)getBannerInstructionForIndexInLeg:(uint32_t)indexInLeg __attribute((ns_returns_retained));
/** Gets the voice instruction by an index within a leg */
- (nullable MBXVoiceInstruction *)getVoiceInstructionForIndexInLeg:(uint32_t)indexInLeg __attribute((ns_returns_retained));
/**
