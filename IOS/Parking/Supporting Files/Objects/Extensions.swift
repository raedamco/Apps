...
extension UITextField {
    ...
    func setBottomBorderNotSelected() {
        ...
        self.layer.backgroundColor = standardBackgroundColor.cgColor
        self.layer.shadowColor = standardContrastColor.cgColor
    }
...
extension String {
    ...
    func converToPhoneFormat(pattern: String, replacmentCharacter: Character) -> String {
...
extension UIViewController {
    ...
    func navigationbarAttributes(Hidden: Bool, Translucent: Bool){
    ...
    func setupNavigationBar(LargeText: Bool, Title: String, SystemImageR: Bool, ImageR: Bool, ImageTitleR: String, TargetR: Any?, ActionR: Selector?, SystemImageL: Bool, ImageL: Bool, ImageTitleL: String, TargetL: Any?, ActionL: Selector?){
        self.navigationItem.title = Title
        self.navigationController?.navigationBar.prefersLargeTitles = LargeText
