...
class SearchViewController: UIViewController, UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    var tableView = createTableView(Cell: UITableViewCell.self, CellIdentifier: "SearchCells", Scroll: true, Select: true, RowHeight: 50, SeperatorColor: .gray)
    ...
    let googleAPIKey = "AIzaSyDONTZJEYMYC0tXKKdXt8RiO0n4lbIG9RM"
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        AF.request(url!, method: .get, headers: nil).validate().responseJSON { (response) in
